function showRooms(rooms) {
    ...
    rooms.forEach((roomDetails) => {
        ...
        const roomHTML = `
            <div class="room anim" data-id="${roomDetails._id}" data-nsId="${roomDetails.workSpaceId}" data-ns="Workspace Name" data-animtochilds="false" data-animDelay="${0.1}" data-animchilddelays="0.1" data-animdirection="leftToRight" data-startoffset="3px">
                <div class="room-name">
                ${mode}                    
