...
function addRooms(roomDetails) {
    ...
    const roomHTML = `
        <div class="room anim remove_sidebar" data-id="${roomDetails._id}" data-nsId="${roomDetails.workSpaceId}" data-ns="${roomDetails.endPoint}" data-animtochilds="false" data-animDelay="${0.1}" data-animchilddelays="0.1" data-animdirection="leftToRight" data-startoffset="3px">
            <div class="room-name">
                ${mode}                    
                <span class="room-hash"># </span><span class="roomName">${roomDetails.name}</span>
    ...
    lastRoom.querySelector('.room-name').addEventListener('click', function(e) {
        const curRoomId = document.querySelector('.room-details').dataset.roomid;
        if(curRoomId.toString() !== roomDetails._id.toString()) {
            joinRoom({
    ...
    const remove_sidebar_link = roomContainer.querySelector(`.remove_sidebar[data-id="${roomDetails._id}"]`);
    remove_sidebar_link.addEventListener('click', remove_sidebar);
...
function addNewRoom(roomDetails, workSpace) {
    ...
    const roomHTML = `
        <div class="room anim remove_sidebar" data-id="${roomDetails._id}" data-nsId="${workSpace._id}" data-ns="${workSpace.endPoint}" data-animtochilds="false" data-animDelay="${0.1}" data-animchilddelays="0.1" data-animdirection="leftToRight" data-startoffset="3px">
            <div class="room-name">
                ${mode}                    
...
function deleteRooom(roomDetails) {
    ...
    const room = roomContainer.querySelector(`.room[data-id="${roomDetails.roomId}"][data-ns="${roomDetails.nsEndPoint}"]`);
            ...
            const messageHtml = `
                <div class="message" data-userid=${message.user.id}>
                    <div class="message-inner">
                        <div class="header">
                            <div class="user-img userLink pointer ${className}" data-userid=${message.user.id}>
                ...
                <div class="message" data-userid=${messageObj.user.id}>
                    <div class="message-inner">
                        <div class="header">
                            ...
                            <div class="message-body">
                                <div class="message-header">
                                    <div class="user userLink pointer ${className}" data-userid=${messageObj.user.id}>
...
function addImageMessageToRoom(data) {
}
